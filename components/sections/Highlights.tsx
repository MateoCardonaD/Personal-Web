            ...
            >
              ...
              {(language === 'en' ? items : itemsEs).map((item, i) => (
                <article
                  ...
                  className={`snap-center snap-always shrink-0 rounded-2xl border border-neutral-200/60 dark:border-neutral-800 bg-[#F7F4EF] dark:bg-neutral-950 p-4 sm:p-7 md:p-9 shadow-sm w-[calc(100vw-3rem)] sm:w-[calc(100vw-6rem)] md:w-[calc(100vw-8rem)] lg:w-[600px] xl:w-[700px] transition-[opacity,transform] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] scroll-ml-12 scroll-mr-12 ${
