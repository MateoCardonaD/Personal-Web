    ...
    <>
      ...
      <section id="tagline" className="w-full">
        <div ref={rootRef} className="mx-auto max-w-6xl px-4 py-16 sm:py-24">
          <h2 className="tracking-tight text-neutral-800 dark:text-neutral-100 font-bold leading-[1.02] text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-center sm:text-left">
            {lines.map((l, i) => (
              <span
                key={i}
